...
client.on('ready', function(){
    ...
    console.log(` 👑╲⎝ м͠ɑ͠Zeи͠™⎠╱👑|> Name: ${client.user.username}`);
 console.log(` 👑╲⎝ м͠ɑ͠Zeи͠™⎠╱👑 |> Servers: ${client.guilds.size}`);
 console.log(` 476088952726749188 |> Members: ${client.users.size}`);
 console.log(` 555833541812813844 |> Channels: ${client.channels.size}`);
 console.log(` 555833541812813844 |> Channels: ${client.channels.size}`);
 console.log(` 555833541812813844 |> Id: ${client.user.id}`);
 console.log(` 555833541812813844`);
 console.log(` 555833541812813844`);
});
